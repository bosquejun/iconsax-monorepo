    ...
    const EmptyWalletTickTwotoneIcon = (props:IconPropTypes) => {
...
<path d="M3.43945 19L4.42944 19.99L6.55945 18.02" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default EmptyWalletTickTwotoneIcon;
