    ...
    const Icon1TwotoneIcon = (props:IconPropTypes) => {
...
<path d="M4.22 15.2803L3 16.5002L4.22 17.7202" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M9.5 21.7803H4.16C3.52 21.7803 3 21.2603 3 20.6203V19.3403" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M8.2793 23.0001L9.4993 21.7801L8.2793 20.5601" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default Icon1TwotoneIcon;
