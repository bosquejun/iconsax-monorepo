    ...
    const AquariusTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M15 19H9" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default AquariusTwotoneIcon;
