    ...
    const FolderFavoriteTwotoneIcon = (props:IconPropTypes) => {
      const { color = 'black', size = 24, ...otherProps } = props
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill={color} {...otherProps} >
          <path opacity="0.4" d="M9.20046 14.78L11.7805 17.04C11.9005 17.15 12.0905 17.15 12.2105 17.04L14.7905 14.78C15.4605 14.19 15.5505 13.19 14.9905 12.49C14.4305 11.79 13.4105 11.66 12.7005 12.2L12.0005 12.74L11.2905 12.21C10.5705 11.67 9.56046 11.8 9.00046 12.5C8.44046 13.19 8.53046 14.2 9.20046 14.78Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M22 11V17C22 21 21 22 17 22H7C3 22 2 21 2 17V7C2 3 3 2 7 2H8.5C10 2 10.33 2.44 10.9 3.2L12.4 5.2C12.78 5.7 13 6 14 6H17C21 6 22 7 22 11Z" stroke={color} stroke-width="1.5" stroke-miterlimit="10" />
    ...
    export default FolderFavoriteTwotoneIcon;
