    ...
    const RotateLeftTwotoneIcon = (props:IconPropTypes) => {
...
<path d="M7.86914 5.31982L11.2391 7.77982" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default RotateLeftTwotoneIcon;
