    ...
    const EmptyWalletRemoveTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M7 12H14" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M6.06922 20.0402L3.94922 17.9302" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M6.04969 17.96L3.92969 20.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default EmptyWalletRemoveTwotoneIcon;
