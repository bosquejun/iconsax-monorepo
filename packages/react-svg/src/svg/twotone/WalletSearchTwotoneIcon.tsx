    ...
    const WalletSearchTwotoneIcon = (props:IconPropTypes) => {
...
<path d="M2 22L3 21" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default WalletSearchTwotoneIcon;
