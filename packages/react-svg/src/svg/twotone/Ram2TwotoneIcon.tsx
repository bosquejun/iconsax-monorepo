    ...
    const Ram2TwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M8.94043 4.95006L8.99043 2.06006" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path opacity="0.4" d="M11.9404 4.95006L11.9904 2.06006" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path opacity="0.4" d="M14.9404 4.92004L14.9904 2.04004" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default Ram2TwotoneIcon;
