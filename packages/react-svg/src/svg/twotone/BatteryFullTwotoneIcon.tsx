    ...
    const BatteryFullTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.34" d="M9.88086 10C10.2109 11.31 10.2109 12.69 9.88086 14" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path opacity="0.34" d="M13.3809 10C13.7109 11.31 13.7109 12.69 13.3809 14" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M13 19H7C3 19 2 18 2 14V10C2 6 3 5 7 5H13C17 5 18 6 18 10V14C18 18 17 19 13 19Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default BatteryFullTwotoneIcon;
