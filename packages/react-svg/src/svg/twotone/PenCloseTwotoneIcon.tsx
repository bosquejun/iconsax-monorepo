    ...
    const PenCloseTwotoneIcon = (props:IconPropTypes) => {
...
<path d="M7.7003 7.67981L5.32031 5.2998" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M7.68077 5.31982L5.30078 7.69983" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default PenCloseTwotoneIcon;
