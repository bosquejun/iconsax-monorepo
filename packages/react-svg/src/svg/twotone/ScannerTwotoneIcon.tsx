    ...
    const ScannerTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M2 12H22" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ScannerTwotoneIcon;
