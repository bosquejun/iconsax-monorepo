    ...
    const VolumeCrossTwotoneIcon = (props:IconPropTypes) => {
      const { color = 'black', size = 24, ...otherProps } = props
      return (
        <svg width={size} height={size} viewBox="0 0 22 18" fill={color} {...otherProps} >
    ...
    export default VolumeCrossTwotoneIcon;
