    ...
    const ShieldTickTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M9.05078 11.8702L10.6608 13.4802L14.9608 9.18018" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ShieldTickTwotoneIcon;
