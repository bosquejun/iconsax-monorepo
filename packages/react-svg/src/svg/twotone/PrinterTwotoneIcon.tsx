    ...
    const PrinterTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M7 11H10" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default PrinterTwotoneIcon;
