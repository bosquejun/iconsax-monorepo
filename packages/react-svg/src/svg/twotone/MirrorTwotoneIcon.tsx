    ...
    const MirrorTwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M6 22H18" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MirrorTwotoneIcon;
