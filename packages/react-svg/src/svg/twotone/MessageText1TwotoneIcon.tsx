    ...
    const MessageText1TwotoneIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M7 8H17" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path opacity="0.4" d="M7 13H13" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default MessageText1TwotoneIcon;
