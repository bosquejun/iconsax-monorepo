    ...
    const CalendarEditBrokenIcon = (props:IconPropTypes) => {
...
<path d="M19.211 15.77L15.671 19.31C15.531 19.45 15.401 19.71 15.371 19.9L15.181 21.25C15.111 21.74 15.451 22.0801 15.941 22.0101L17.291 21.82C17.481 21.79 17.751 21.66 17.881 21.52L21.421 17.9801C22.031 17.3701 22.321 16.6601 21.421 15.7601C20.531 14.8701 19.821 15.16 19.211 15.77Z" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M18.6992 16.28C18.9992 17.36 19.8392 18.2 20.9192 18.5" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M3 13.08V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5V12" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M12 22H8C4.5 22 3 20 3 17" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M8.29529 16.7H8.30427" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default CalendarEditBrokenIcon;
