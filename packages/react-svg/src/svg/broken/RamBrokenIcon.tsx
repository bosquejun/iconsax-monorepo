    ...
    const RamBrokenIcon = (props:IconPropTypes) => {
...
<path d="M13.9707 7.78003H7.9707" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default RamBrokenIcon;
