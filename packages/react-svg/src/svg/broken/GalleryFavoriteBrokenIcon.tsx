    ...
    const GalleryFavoriteBrokenIcon = (props:IconPropTypes) => {
...
<path d="M2 12.98V15C2 20 4 22 9 22H15C20 22 22 20 22 15V11" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M12 2H9C4 2 2 4 2 9" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M16.1197 5.1099C15.7897 4.0699 16.1797 2.7799 17.2597 2.4299C17.8297 2.2499 18.5397 2.3999 18.9397 2.9499C19.3197 2.3799 20.0497 2.2399 20.6197 2.4299C21.7097 2.7799 22.0997 4.0699 21.7697 5.1099C21.2497 6.7499 19.4497 7.6099 18.9497 7.6099C18.4397 7.6099 16.6497 6.7699 16.1197 5.1099Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M2.66992 18.9501L7.59992 15.6401C8.38992 15.1101 9.52992 15.1701 10.2399 15.7801L10.5699 16.0701C11.3499 16.7401 12.6099 16.7401 13.3899 16.0701L17.5499 12.5001C18.3299 11.8301 19.5899 11.8301 20.3699 12.5001L21.9999 13.9001" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default GalleryFavoriteBrokenIcon;
