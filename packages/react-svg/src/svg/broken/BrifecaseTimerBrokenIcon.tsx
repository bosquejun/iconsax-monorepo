    ...
    const BrifecaseTimerBrokenIcon = (props:IconPropTypes) => {
...
<path d="M12.25 12.95V13.88C12.25 14.23 12.07 14.56 11.76 14.74L11 15.2" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M20.9508 18.43C20.7408 20.39 20.0208 22 16.0008 22H8.0008C3.9808 22 3.2608 20.39 3.0508 18.43L2.3008 10.43C2.0308 7.99 2.7308 6 7.0008 6H17.0008C21.2708 6 21.9708 7.99 21.7008 10.43L21.3708 14" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M2.61914 11.27C4.28914 12.41 6.10914 13.22 7.99914 13.68" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default BrifecaseTimerBrokenIcon;
