    ...
    const BriefcaseBrokenIcon = (props:IconPropTypes) => {
...
<path d="M2.61914 11.27C4.86914 12.81 7.40914 13.74 9.99914 14.03" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default BriefcaseBrokenIcon;
