    ...
    const DocumentText1BrokenIcon = (props:IconPropTypes) => {
...
<path d="M8 17H16" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default DocumentText1BrokenIcon;
