    ...
    const PenToolBrokenIcon = (props:IconPropTypes) => {
...
<path d="M5.46094 10.1002L8.11094 7.4502" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M10.7513 22.4999H13.2713C14.2313 22.4999 14.8513 21.8199 14.6713 20.9899L14.2613 19.1799H9.76131L9.3513 20.9899C9.1713 21.7699 9.8513 22.4999 10.7513 22.4999Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M14.2208 12.6699L13.1708 11.3399C12.5308 10.5299 11.4808 10.5299 10.8408 11.3399L7.79078 15.2099C7.02078 16.1799 7.02078 16.8099 8.03078 17.6399L9.76078 19.1799" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M12.0117 11.1201V13.6501" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default PenToolBrokenIcon;
