    ...
    const GalleryRemoveBrokenIcon = (props:IconPropTypes) => {
...
<path d="M16.5605 5.93957L20.4405 2.05957" stroke={color} stroke-width="1.5" stroke-linecap="round" />
<path d="M20.4405 5.93957L16.5605 2.05957" stroke={color} stroke-width="1.5" stroke-linecap="round" />
        </svg>
      )
    }
    
    
    export default GalleryRemoveBrokenIcon;
