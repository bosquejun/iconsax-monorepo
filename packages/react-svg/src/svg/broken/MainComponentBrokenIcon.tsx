    ...
    const MainComponentBrokenIcon = (props:IconPropTypes) => {
...
<path d="M15.5 8.5L6.25 17.75" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MainComponentBrokenIcon;
