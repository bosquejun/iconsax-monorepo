...
<path d="M13.75 13.3101H10.25" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default AutobrightnessBrokenIcon;
