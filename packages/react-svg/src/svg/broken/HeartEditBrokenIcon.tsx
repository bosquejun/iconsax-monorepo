    ...
    const HeartEditBrokenIcon = (props:IconPropTypes) => {
      const { color = 'black', size = 24, ...otherProps } = props
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill={color} {...otherProps} >
          <path d="M12 20.9C11.78 20.9 11.55 20.87 11.38 20.81C8.48 19.82 2 15.69 2 8.69C2 7.29 2.51 6.01003 3.36 5.03003" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M21.4905 12C21.8105 10.98 22.0005 9.88 22.0005 8.69C22.0005 5.6 19.5105 3.09998 16.4405 3.09998C14.6205 3.09998 13.0105 3.98003 12.0005 5.34003C10.9905 3.98003 9.37055 3.09998 7.56055 3.09998" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M18.6992 16.25C18.9992 17.33 19.8392 18.17 20.9192 18.47" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default HeartEditBrokenIcon;
