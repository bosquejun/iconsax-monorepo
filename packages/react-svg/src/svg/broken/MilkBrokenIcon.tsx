    ...
    const MilkBrokenIcon = (props:IconPropTypes) => {
      const { color = 'black', size = 24, ...otherProps } = props
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill={color} {...otherProps} >
          <path d="M6 13.98L9.89001 14C10.62 14 11.34 14.17 12 14.5C12.66 14.83 13.38 15 14.12 15H18V19C18 20.65 16.65 22 15 22H9C7.35 22 6 20.65 6 19V17.99" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
