    ...
    const ImportBrokenIcon = (props:IconPropTypes) => {
...
<path d="M15.3504 12.6499L12.0004 15.9999L8.65039 12.6499" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ImportBrokenIcon;
