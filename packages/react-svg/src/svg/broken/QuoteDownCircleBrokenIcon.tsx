    ...
    const QuoteDownCircleBrokenIcon = (props:IconPropTypes) => {
...
<path d="M13.1406 12.1599H15.8206C16.5306 12.1599 17.0106 12.6999 17.0106 13.3499V14.84C17.0106 15.49 16.5306 16.03 15.8206 16.03H14.3306C13.6806 16.03 13.1406 15.49 13.1406 14.84V12.1599Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M4 6C2.75 7.67 2 9.75 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2C10.57 2 9.2 2.29998 7.97 2.84998" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default QuoteDownCircleBrokenIcon;
