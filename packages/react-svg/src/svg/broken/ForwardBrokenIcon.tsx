    ...
    const ForwardBrokenIcon = (props:IconPropTypes) => {
...
<path d="M14.68 6.65007C13.38 5.90007 11.75 6.84007 11.75 8.34007V15.6601C11.75 17.1601 13.38 18.1001 14.68 17.3501L17.85 15.5301L21.02 13.7001C22.32 12.9501 22.32 11.0801 21.02 10.3201L18.84 9.06008" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
