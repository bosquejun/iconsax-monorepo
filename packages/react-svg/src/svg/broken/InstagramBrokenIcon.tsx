    ...
    const InstagramBrokenIcon = (props:IconPropTypes) => {
...
<path d="M17.6361 7H17.6477" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default InstagramBrokenIcon;
