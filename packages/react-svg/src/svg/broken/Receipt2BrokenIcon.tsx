    ...
    const Receipt2BrokenIcon = (props:IconPropTypes) => {
...
<path d="M15 10.25H16" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M8 10.25H12" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M8 13.75H14" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default Receipt2BrokenIcon;
