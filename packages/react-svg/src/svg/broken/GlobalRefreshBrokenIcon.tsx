    ...
    const GlobalRefreshBrokenIcon = (props:IconPropTypes) => {
...
<path d="M20.0401 14.8L18.5801 15.86" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default GlobalRefreshBrokenIcon;
