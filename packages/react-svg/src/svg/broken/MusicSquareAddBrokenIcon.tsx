    ...
    const MusicSquareAddBrokenIcon = (props:IconPropTypes) => {
...
<path d="M19.4898 17.98H16.5098" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M18 16.52V19.51" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MusicSquareAddBrokenIcon;
