    ...
    const ArrowRight2OutlineIcon = (props:IconPropTypes) => {
...
<path d="M14.5 12.75H8.5C8.09 12.75 7.75 12.41 7.75 12C7.75 11.59 8.09 11.25 8.5 11.25H14.5C14.91 11.25 15.25 11.59 15.25 12C15.25 12.41 14.91 12.75 14.5 12.75Z" fill={color} />
<path d="M12.4995 15.7499C12.3095 15.7499 12.1195 15.6799 11.9695 15.5299C11.6795 15.2399 11.6795 14.7599 11.9695 14.4699L14.4395 11.9999L11.9695 9.52994C11.6795 9.23994 11.6795 8.75994 11.9695 8.46994C12.2595 8.17994 12.7395 8.17994 13.0295 8.46994L16.0295 11.4699C16.3195 11.7599 16.3195 12.2399 16.0295 12.5299L13.0295 15.5299C12.8795 15.6799 12.6895 15.7499 12.4995 15.7499Z" fill={color} />
        </svg>
      )
    }
    
    
    export default ArrowRight2OutlineIcon;
