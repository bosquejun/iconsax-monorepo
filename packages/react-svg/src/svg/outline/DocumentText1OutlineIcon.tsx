    ...
    const DocumentText1OutlineIcon = (props:IconPropTypes) => {
...
<path d="M11 17.75H7C6.59 17.75 6.25 17.41 6.25 17C6.25 16.59 6.59 16.25 7 16.25H11C11.41 16.25 11.75 16.59 11.75 17C11.75 17.41 11.41 17.75 11 17.75Z" fill={color} />
        </svg>
      )
    }
    
    
    export default DocumentText1OutlineIcon;
