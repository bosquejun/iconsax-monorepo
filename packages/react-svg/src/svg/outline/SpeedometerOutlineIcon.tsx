    ...
    const SpeedometerOutlineIcon = (props:IconPropTypes) => {
...
<path d="M11.9989 22.25C9.7289 22.25 7.87891 20.4 7.87891 18.13C7.87891 15.86 9.7289 14 11.9989 14C14.2689 14 16.1189 15.85 16.1189 18.12C16.1189 20.39 14.2689 22.25 11.9989 22.25ZM11.9989 15.5C10.5489 15.5 9.37891 16.68 9.37891 18.12C9.37891 19.56 10.5589 20.74 11.9989 20.74C13.4389 20.74 14.6189 19.56 14.6189 18.12C14.6189 16.68 13.4489 15.5 11.9989 15.5Z" fill={color} />
<path d="M16 12.75H15.25C14.42 12.75 13.75 12.08 13.75 11.25V10.5C13.75 9.26 14.76 8.25 16 8.25C17.24 8.25 18.25 9.26 18.25 10.5C18.25 11.74 17.24 12.75 16 12.75ZM16 9.75C15.59 9.75 15.25 10.09 15.25 10.5V11.25H16C16.41 11.25 16.75 10.91 16.75 10.5C16.75 10.09 16.41 9.75 16 9.75Z" fill={color} />
        </svg>
      )
    }
    
    
    export default SpeedometerOutlineIcon;
