    ...
    const PauseCircleOutlineIcon = (props:IconPropTypes) => {
...
<path d="M10.01 15.9498H8.71C7.79 15.9498 7.25 15.4198 7.25 14.5298V9.4698C7.25 8.5798 7.8 8.0498 8.71 8.0498H10C10.92 8.0498 11.46 8.5798 11.46 9.4698V14.5298C11.47 15.4198 10.92 15.9498 10.01 15.9498ZM8.75 14.4498H9.97V9.5498H8.76L8.75 14.4498Z" fill={color} />
<path d="M15.2891 15.9498H13.9991C13.0791 15.9498 12.5391 15.4198 12.5391 14.5298V9.4698C12.5391 8.5798 13.0891 8.0498 13.9991 8.0498H15.2891C16.2091 8.0498 16.7491 8.5798 16.7491 9.4698V14.5298C16.7491 15.4198 16.1991 15.9498 15.2891 15.9498ZM14.0291 14.4498H15.2491V9.5498H14.0391L14.0291 14.4498Z" fill={color} />
        </svg>
      )
    }
