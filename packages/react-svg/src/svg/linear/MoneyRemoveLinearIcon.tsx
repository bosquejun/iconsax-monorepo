    ...
    const MoneyRemoveLinearIcon = (props:IconPropTypes) => {
...
<path d="M6.07117 19.0399L3.96118 16.9299" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M6.03992 16.96L3.92993 19.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MoneyRemoveLinearIcon;
