    ...
    const BoxSearchLinearIcon = (props:IconPropTypes) => {
...
<path d="M23 22L22 21" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default BoxSearchLinearIcon;
