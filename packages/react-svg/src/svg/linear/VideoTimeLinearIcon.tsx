    ...
    const VideoTimeLinearIcon = (props:IconPropTypes) => {
...
<path d="M18.78 17.0901V18.7801L17.38 19.6201" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default VideoTimeLinearIcon;
