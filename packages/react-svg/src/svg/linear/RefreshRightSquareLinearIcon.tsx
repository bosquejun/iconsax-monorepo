    ...
    const RefreshRightSquareLinearIcon = (props:IconPropTypes) => {
...
<path d="M14.38 7.64999L12.72 5.73999" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M14.3799 7.6499L12.4399 9.0699" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default RefreshRightSquareLinearIcon;
