    ...
    const BoxRemoveLinearIcon = (props:IconPropTypes) => {
...
<path d="M20.07 19.0399L17.95 16.9299" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M20.05 16.96L17.93 19.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default BoxRemoveLinearIcon;
