    ...
    const ExportLinearIcon = (props:IconPropTypes) => {
...
<path d="M15.35 5.85L12 2.5L8.65002 5.85" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ExportLinearIcon;
