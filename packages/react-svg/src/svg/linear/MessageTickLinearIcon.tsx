    ...
    const MessageTickLinearIcon = (props:IconPropTypes) => {
...
<path d="M3.44 17.5L4.42999 18.49L6.56 16.52" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M8.5 10.5H15.5" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default MessageTickLinearIcon;
