    ...
    const ShieldTickLinearIcon = (props:IconPropTypes) => {
...
<path d="M9.05005 11.8701L10.66 13.4801L14.96 9.18005" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ShieldTickLinearIcon;
