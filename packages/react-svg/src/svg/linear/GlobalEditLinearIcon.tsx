    ...
    const GlobalEditLinearIcon = (props:IconPropTypes) => {
...
<path d="M18.7 16.25C19 17.33 19.84 18.17 20.92 18.47" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default GlobalEditLinearIcon;
