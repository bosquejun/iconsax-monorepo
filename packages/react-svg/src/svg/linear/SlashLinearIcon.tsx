    ...
    const SlashLinearIcon = (props:IconPropTypes) => {
...
<path d="M18.9 5L4.90002 19" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default SlashLinearIcon;
