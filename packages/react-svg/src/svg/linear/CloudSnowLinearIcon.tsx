    ...
    const CloudSnowLinearIcon = (props:IconPropTypes) => {
...
<path d="M12.9955 18.5H13.0045" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
<path d="M8.9955 18.5H9.0045" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
<path d="M10.9955 21.5H11.0045" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default CloudSnowLinearIcon;
