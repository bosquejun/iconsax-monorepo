    ...
    const MoreCircleLinearIcon = (props:IconPropTypes) => {
...
<path d="M11.9955 12H12.0045" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
<path d="M7.99451 12H8.00349" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    export default MoreCircleLinearIcon;
