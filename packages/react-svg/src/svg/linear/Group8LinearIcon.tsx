    ...
    const Group8LinearIcon = (props:IconPropTypes) => {
...
<path d="M4.93994 19.0799L19.0799 4.93994" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default Group8LinearIcon;
