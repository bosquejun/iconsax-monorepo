    ...
    const MusicSquareRemoveLinearIcon = (props:IconPropTypes) => {
...
<path d="M6.72002 14.42C7.52084 14.42 8.17002 13.7708 8.17002 12.97C8.17002 12.1692 7.52084 11.52 6.72002 11.52C5.91921 11.52 5.27002 12.1692 5.27002 12.97C5.27002 13.7708 5.91921 14.42 6.72002 14.42Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M13.47 12V6.34001C13.47 5.13001 12.71 4.96997 11.95 5.17997L9.06004 5.96995C8.54004 6.10995 8.17004 6.52999 8.17004 7.12999V8.14V8.81999V12.97" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M8.17004 8.8299L13.47 7.37988" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
<path d="M19.0701 19.0399L16.9501 16.9299" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M19.0501 16.96L16.9301 19.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MusicSquareRemoveLinearIcon;
