    ...
    const TruckTimeLinearIcon = (props:IconPropTypes) => {
...
<path d="M5.25 3.75V5.25L4 6" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default TruckTimeLinearIcon;
