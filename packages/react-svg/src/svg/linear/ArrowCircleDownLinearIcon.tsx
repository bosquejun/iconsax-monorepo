    ...
    const ArrowCircleDownLinearIcon = (props:IconPropTypes) => {
...
<path d="M8.46997 10.74L12 14.26L15.53 10.74" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default ArrowCircleDownLinearIcon;
