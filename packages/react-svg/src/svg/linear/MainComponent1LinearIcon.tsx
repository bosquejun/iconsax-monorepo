    ...
    const MainComponent1LinearIcon = (props:IconPropTypes) => {
...
<path d="M6.25 6.25L17.75 17.75" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
<path d="M17.75 6.25L6.25 17.75" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default MainComponent1LinearIcon;
