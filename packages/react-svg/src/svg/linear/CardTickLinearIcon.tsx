    ...
    const CardTickLinearIcon = (props:IconPropTypes) => {
...
<path d="M16.4414 17.9995L17.4314 18.9895L19.5614 17.0195" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default CardTickLinearIcon;
