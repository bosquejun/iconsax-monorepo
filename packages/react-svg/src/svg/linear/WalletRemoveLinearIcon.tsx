    ...
    const WalletRemoveLinearIcon = (props:IconPropTypes) => {
...
<path d="M6.07117 20.0399L3.96118 17.9299" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
<path d="M6.03992 17.96L3.92993 20.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )
    }
    
    
    export default WalletRemoveLinearIcon;
