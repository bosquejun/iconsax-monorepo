    ...
    const FingerCricleLinearIcon = (props:IconPropTypes) => {
...
<path d="M12 14.88C11.09 14.88 10.35 14.14 10.35 13.23V10.76C10.35 9.85001 11.09 9.10999 12 9.10999C12.91 9.10999 13.65 9.85001 13.65 10.76V13.23C13.65 14.14 12.91 14.88 12 14.88Z" stroke={color} stroke-width="1.5" stroke-linecap="round" />
<path d="M16.98 13.4699C16.78 16.0499 14.62 18.0699 12 18.0699C9.24 18.0699 7 15.8299 7 13.0699V10.9299C7 8.16993 9.24 5.92993 12 5.92993C14.59 5.92993 16.72 7.89992 16.97 10.4199" stroke={color} stroke-width="1.5" stroke-linecap="round" />
    ...
    export default FingerCricleLinearIcon;
