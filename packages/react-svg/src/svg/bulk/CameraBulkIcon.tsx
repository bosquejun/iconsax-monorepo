...
<path d="M11.9991 18.1301C13.8659 18.1301 15.3791 16.6168 15.3791 14.7501C15.3791 12.8834 13.8659 11.3701 11.9991 11.3701C10.1324 11.3701 8.61914 12.8834 8.61914 14.7501C8.61914 16.6168 10.1324 18.1301 11.9991 18.1301Z" fill={color} />
        </svg>
      )
    }
    
    
    export default CameraBulkIcon;
