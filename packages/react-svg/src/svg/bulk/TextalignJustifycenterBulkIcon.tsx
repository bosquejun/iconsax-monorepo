    ...
    const TextalignJustifycenterBulkIcon = (props:IconPropTypes) => {
...
<path opacity="0.4" d="M21 10.25H3C2.59 10.25 2.25 9.91 2.25 9.5C2.25 9.09 2.59 8.75 3 8.75H21C21.41 8.75 21.75 9.09 21.75 9.5C21.75 9.91 21.41 10.25 21 10.25Z" fill={color} />
...
<path opacity="0.4" d="M21 20.25H3C2.59 20.25 2.25 19.91 2.25 19.5C2.25 19.09 2.59 18.75 3 18.75H21C21.41 18.75 21.75 19.09 21.75 19.5C21.75 19.91 21.41 20.25 21 20.25Z" fill={color} />
    ...
    export default TextalignJustifycenterBulkIcon;
