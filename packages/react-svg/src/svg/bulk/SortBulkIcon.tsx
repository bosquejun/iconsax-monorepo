    ...
    const SortBulkIcon = (props:IconPropTypes) => {
...
<path d="M13.3302 17H10.6602C10.2502 17 9.91016 16.66 9.91016 16.25C9.91016 15.84 10.2502 15.5 10.6602 15.5H13.3302C13.7402 15.5 14.0802 15.84 14.0802 16.25C14.0802 16.66 13.7502 17 13.3302 17Z" fill={color} />
        </svg>
      )
    }
    
    
    export default SortBulkIcon;
